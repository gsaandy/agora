...
import com.nibodha.agora.services.re.components.rs.test.TestService;
...
public class RsEndpointTest extends CamelTestSupport {
    ...
    public void testCreateRsEndpointWithWithResourceClass() throws Exception{
        final String endpointUri = "cxfrs://http://localhost:" + AvailablePortFinder.getNextAvailable() + "/rsTest?&resourceClass=com.nibodha.agora.services.re.components.rs.test.TestService";
        RsComponent component = new RsComponent(context);
        RsEndpoint endpoint = (RsEndpoint) component.createEndpoint(endpointUri);
    ...
    public void testCreateRsEndpointWithWithResourceClasses() throws Exception{
        final String endpointUri = "cxfrs://http://localhost:" + AvailablePortFinder.getNextAvailable() + "/rsTest?&resourceClasses=com.nibodha.agora.services.re.components.rs.test.TestService,java.lang.String";
        RsComponent component = new RsComponent(context);
        RsEndpoint endpoint = (RsEndpoint) component.createEndpoint(endpointUri);
